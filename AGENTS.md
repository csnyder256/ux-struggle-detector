...
GET http://localhost:8900/must-read?project=ux-struggle-detector

Then search shared memory for the task, using project=ux-struggle-detector first and global
